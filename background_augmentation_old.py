...
# 数据集路径
dataset_image_path=r'./data_image'
...
for i in range(len(dataset_image_list)):
    ...
    # 腐蚀膨胀
    erode = cv2.erode(mask_invert, (3,3), iterations=3)
    # cv2.imshow('erode', erode)
    dilate = cv2.dilate(erode, (3,3), iterations=2)
